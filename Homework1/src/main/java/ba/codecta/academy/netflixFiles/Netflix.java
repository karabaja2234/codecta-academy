        ...
        do {
            ...
            do {
                if(chosenOption < 1 || chosenOption > 3) {
                    System.out.println("Enter one of the values from 1 to 3!");
                }
                    ...
                    do {
                        ...
                        do {
                            if(chosenMovie < 1 || chosenMovie > moviesList.size()) {
                                System.out.println("Choose one of the movies from the list!");
                            } else {
                                movieIsChosen = true;
                            }
                        } while(chosenMovie < 1 || chosenMovie > moviesList.size());
